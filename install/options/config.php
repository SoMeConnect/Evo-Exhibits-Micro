        ...
        public function setSections() {
			...
			**/
			...
			/* ==============================
				Header
			============================== */
			$someoptions = get_option('some_theme_option');
			$this->sections[] = array(
				...
				'fields'	=> array(
					...
					array(
						...
						'type' => 'border',
						'hidden' => ($someoptions['transitional-header-button'] == 0) ? true : false,
            ...
            $this->sections[] = array(
	            ...
	            'fields'    => array(
					...
					array(
						...
						'desc'	=> __('', 'redux-framework-demo'),
						//'validate'	=> 'numeric',
						'default'	=> '&copy;2017 <a href="http://somemultimedia.com">some Multimedia</a>',
					),
					array(
        ...
        **/
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'opt_name'          => 'some_theme_option',		// This is where your data is stored in the database and also becomes your global variable name.
