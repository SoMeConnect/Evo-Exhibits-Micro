    ...
    <div class="line4">		
        <div class="container">
            <div class="row Ama">
                <div class="col-md-12">
                    <h3>Videos</h3>
                    <p style="font-size:20px;">Less reading, more watching! Check out our latest videos!</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row news2 news">
            ...
            <div class="col-md-6 text-center youtube">
                ...
                <h3><a href="https://www.linkedin.com/feed/update/urn:li:activity:6317094052500246528" target="new">Evo Exhibits made the Inc. 5000 list for the 5th time!</a></h3>
